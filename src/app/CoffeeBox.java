 ...
 * Ми симулюємо торговий автомат з солодощами. Покупець вибирає позицію
 * покупки та вставляє гроші. Кожен товар кратний 25коп. Наше завдання полягає в
 * обчисленні, скільки коштів кожного типу, повернулося.
 * Варіанти класів: Scanner(System.in)
 */
